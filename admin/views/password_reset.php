...
<form method="post" action="password_reset.php" name="password_reset_form">
    ...
    <input class="form-control" placeholder="Enter your username" id="user_name" type="text" name="user_name" required /><br />
    <input class="btn btn-primary" type="submit" name="request_password_reset" value="<?php echo WORDING_RESET_PASSWORD; ?>" />
</form>
<?php } ?>
<br />
<a class="btn btn-primary" href="index.php"><?php echo WORDING_BACK_TO_LOGIN; ?></a>
</body>
